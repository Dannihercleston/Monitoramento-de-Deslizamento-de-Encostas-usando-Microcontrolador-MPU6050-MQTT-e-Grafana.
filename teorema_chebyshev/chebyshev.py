...
# Carregar o CSV
df = pd.read_csv("/home/livia/Documentos/integrador/Monitoramento-de-Deslizamento-de-Encostas-usando-Microcontrolador-MPU6050-MQTT-e-Grafana./teorema_chebyshev/dados_filtrados.csv", comment='#')
...
resultados_df.to_csv('/home/livia/Documentos/integrador/Monitoramento-de-Deslizamento-de-Encostas-usando-Microcontrolador-MPU6050-MQTT-e-Grafana./teorema_chebyshev/dados_48h.csv', index=False)
