...
df = pd.read_csv("/home/livia/Documentos/sensor/Monitoramento-de-Deslizamento-de-Encostas-usando-Microcontrolador-MPU6050-MQTT-e-Grafana./teorema_chebyshev/query (5).csv")  
...
output_file = 'dados_filtrados3108.csv'
